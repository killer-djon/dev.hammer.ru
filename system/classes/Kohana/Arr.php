...
class Kohana_Arr{
	...
	*/
	...
	public static function make_parent(&$tree, $parent = 'root')
	{
		foreach( $tree as $key => &$item )
		{
			...
			{
				Arr::make_parent($item['children'], $item['id']);
			}
		}
	}
	 ...
	 * @return $key of array
	 */
	public static function array_find($needle, $haystack, $search_keys = false) {
	 ...
	 * @public
	 * @static
	 * Convert recursive object to array
	 *
	...
	public static function check_tree(&$tree)
	{
		if( is_array($tree) && count( $tree ) ){
