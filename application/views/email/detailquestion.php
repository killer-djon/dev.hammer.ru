                                                ...
                                                <div class="col-md-12 col-xs-12 col-sm-12">
                                                    <div class="row">
                                                        <div class="col-md-12 col-xs-12 col-sm-12" id="cart-items">
                                                            <div>Вопрос по детали: <b><?=$userdata['article']?></b></div>
                                                            <div>Отправил: <b><?=$userdata['username']?></b></div>
                                                            <div>Email: <b><?=$userdata['useremail']?></b></div>
                                                            <div>Вопрос: <b><?=$userdata['useremsg']?></b></div>

                                                        <br />
                                                        <br />
                                                        <div class="form-group text-center">
                                                            <?=(isset($thanks)&&!empty($thanks)?$thanks:'');?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
