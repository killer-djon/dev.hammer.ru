...
class Kohana_Pagination {
	 ...
	 * @return  Pagination
	 */
	public static function factory(array $config = array(), $group = 'default')
	{
		return new Pagination($config, $group);
	}
	 ...
	 * @return  void
	 */
	public function __construct(array $config = array(), $group = 'default')
	{
